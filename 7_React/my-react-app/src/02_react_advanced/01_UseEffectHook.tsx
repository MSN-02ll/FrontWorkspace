...
/**
 *  #1. Hook
 *   - Hook은 함수형 컴폰전트 내부에 React의 기능(state선언 및 관리,
 *    생명주기 함수)을 연결할 수 있도록 도와주는 함수.
 *   - 원래 React에서는 컴포넌트가 복잡한 동작을 수행하려면 
 *    클래스 컴포넌트를 써야했지만, 그럴 경우 코드가 복잡하고
 *    가독성이 떨어졌음.
 ...
 */
     ...
     *  업데이트(update)될떄를 감지하여 특정 작업을 수행할 수 있게
     *  도와주는 hook 함수
     * 
     *  #3_1) 생명주기 함수
    ...
    // api 서버와 통신하여 초기 데이터를 load하고자 할때
