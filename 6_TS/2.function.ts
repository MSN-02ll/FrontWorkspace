 ...
 *   - 저장된 타입과 다른값이 전달되거나, 반환되면 컴파일 에러 발생
 * 
 * 
 */
 ...
 *  - 변수명? : type
 *  - Optional Parameter은 type | undefined 유니언 타입으로 설정
 * 
 */
...
objectDesFn2({a:111, b:'pyw', c:false});
 ...
 *  - 타입단언은 개발자가 실제타입을 완벽하게 알고 있을 때만 사용한다.
 * 
 */
 ...
 *  반환할 수 없는 함수나, 도달할 수 없는 코드블럭을 표현할 때
 *  사용
 * 
 *  - never는 예외적인 상황을 명확히 표현하여 버그를 
 *  방지하기 위해서 사용한다.
 * 
 */
 ...
 *  - 함수의 시그니처를 타입으로 정의하는 방법 => 함수타입 표현식
 * 
 */
// 일반함수
