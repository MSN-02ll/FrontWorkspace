...
callableFn(); // grobal(전역)

const obj1 = {
    name : "객체 1",
    callableFn : callableFn
}
obj1.callableFn(); // this??
...
const obj3 ={
    ...
    arrowFn : function(){
        ...
        console.log(getName()); //2? arrowFn의 this를 공유하므로 객체 3
...
printName.apply({name:'pyw'}, ['hello','Mr. Park']);
 ...
 */
const bindFn = user.printName.bind({name:'영우'})
bindFn();